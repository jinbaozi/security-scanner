...
| `check_item` | `insecure_symmetric`、`insecure_asymmetric`、`insecure_hash`、`pseudo_encryption`、`insecure_random`、`library_vuln`、`weak_protocol` |
...
| `weak_protocol` | high | SSLv3/TLSv1.0 等 |
